...
const Skills = () => {
    ...
    return (
        <section id="skills" className=" overflow-x-hidden relative flex flex-col py-20 h-auto px-40 bg-fixed items-start justify-center w-full bg-gradient-to-l  from-cyan-950 to-gray-900">
