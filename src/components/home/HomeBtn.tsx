...
const HomeBtn = ({ text, transparent = false }: { text: string, transparent?: Boolean }) => {
    return (
        <span className="m-1">
            <motion.button whileHover={{ scale: 1.1 }} type="button" className={"inline-flex items-center rounded-md px-3 py-3 text-sm  shadow-sm  focus-visible:outline focus-visible:outline-2 font-semibold focus-visible:outline-offset-2 "
