...
const EffectContainer = () => {
  ...
  return (
    <div className="relative lg:w-96 md:w-64 rounded-xl border-2 border-cyan-500/10 backdrop-blur-sm mx-auto flex justify-center self-end transition-all duration-500 hover:transform hover:-translate-x-2 hover:translate-y-15"
      ...
      <div className='flex flex-col justify-center text-center font-semibold bg-cyan-800 py-1 rounded-xl mx-auto my-4 absolute lg:w-80 md:w-36 left-0 right-0 bottom-0 opacity-100' ref={divRef}>
        <SlickSection list={["Full Stack Developer", "Undergraduate Student", "Video Editor"]} />
      </div>
